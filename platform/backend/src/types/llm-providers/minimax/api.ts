    ...
    .object({
        ...
        message: z
            .object({
                ...
                // MiniMax extension
                reasoning_details: z.array(z.any()).optional(),
            })
            .describe(
...
export const ChatCompletionRequestSchema = z
    .object({
        ...
        // MiniMax extension - this comes from extra_body in SDK, but ends up as top level field in API
...
export const ChatCompletionResponseSchema = z
    .object({
        ...
        // MiniMax extension: base_resp might contain stats
        base_resp: z.any().optional(),
    })
    .describe(
